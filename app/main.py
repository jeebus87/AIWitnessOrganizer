...
from app.api.v1.routes import auth, witnesses, jobs, matters, billing, relevancy, webhooks, test_e2e, legal_research, batch
...
app.include_router(test_e2e.router, prefix="/api/v1")
